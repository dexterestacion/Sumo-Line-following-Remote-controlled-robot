...
both LED indicators for 8 and 2 channel sensors are combine in a single module, including a toggle switch for UART communication of 2 arduino uno and the 2 independent reference voltage for calibrating the sensors in order for adjustments to be accessible when it comes to calibration and debugging.
